...
describe('Validate JS configs', () => {
  it('Validate eslint-config-yan', async () => {
  ...
  it('Validate eslint-config-yan/es5', async () => {
  ...
  it('Validate eslint-config-yan/vue', async () => {
  ...
  it('Validate eslint-config-yan/essential', async () => {
  ...
  it('Validate eslint-config-yan/essential/es5', async () => {
  ...
  it('Validate eslint-config-yan/essential/react', async () => {
  ...
  it('Validate eslint-config-yan/essential/vue', async () => {
  ...
  it('Validate eslint-config-yan/node', async () => {
    ...
    // node/prefer-promises/fs 规则可能在较新版本的 eslint-config-egg 中已移除或改变
    ...
    // 错误数量可能因 eslint-config-egg 版本不同而变化，只要 > 0 即可
    assert.ok(errorCount > 0, `期望有错误，但实际检测到 ${errorCount} 个错误`);
    assert.ok(warningCount >= 0, `期望警告数 >= 0，但实际检测到 ${warningCount} 个警告`);
